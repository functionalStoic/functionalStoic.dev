...
---
import diffGIF from './git-add-patch-in-vscode.gif'
...
Here is a [general description](https://git-scm.com/docs/git-add#Documentation/git-add.txt---patch) of `-p`/`--patch`:
...
<img src={diffGIF} alt="git add --patch in VSCode" width="100%" />
